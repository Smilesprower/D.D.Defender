...
void Alien::init(sf::Texture & tex, sf::Vector2f position, sf::Vector2f velocity)
{
	...
	m_circ.setRadius(10);
	m_circ.setPosition(position);
	m_circ.setPointCount(8);
