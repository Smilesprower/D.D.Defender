...
public:
	...
	sf::Vector2f separation(std::vector<Alien*> *alien, std::vector<Obstacle*> *obstacle, sf::Vector2f playerPos, int index);
	...
	void borders();
	void flock(std::vector<Alien*> *alien, std::vector<Obstacle*> *obstacle, sf::Vector2f playerPos, int index);
